...
function pomme_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'pomme' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'pomme' ),
...
function pomme_scripts() {
	...
	wp_enqueue_script( 'pomme-functions', get_theme_file_uri( '/js/functions.js' ), array(), null, true );
